...
public class PanamahTrocaFormaPagamento {
	...
	public void validate() throws Exception {
		...
		if (this.formaPagamentoDestinoId == null)
			throw new Exception("formaPagamentoDestinoId não pode ser nulo!");
		if (this.formaPagamentoOrigemId == null)
			throw new Exception("formaPagamentoOrigemId não pode ser nulo!");
		if (this.id == null)
			throw new Exception("id não pode ser nulo!");
		if (this.lojaId == null)
			throw new Exception("lojaId não pode ser nulo!");
		if (this.sequencialPagamento == null)
			throw new Exception("sequencialPagamento não pode ser nulo!");
		if (this.valor == null)
